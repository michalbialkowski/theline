function sendMail(t,e,i,n,o){$(t).submit((function(n){n.preventDefault(),$(t).find('button[type="submit"] span').html("Wysyłanie formularza…"),$(t).find('button[type="submit"]').removeClass(e),$(t).find('button[type="submit"]').addClass(i);var o=$(this).attr("data-action"),s=new FormData(jQuery(this)[0]);$.ajax({url:o,data:s,cache:!1,contentType:!1,processData:!1,method:"POST",success:function(e){0==e?($(t).find('button[type="submit"] span').html("Formularz został wysłany"),$(t).find("input").attr("disabled",!0),$(t).find("textarea").attr("disabled",!0),$(t).find("select").attr("disabled",!0),$(t).find('button[type="submit"]').attr("disabled",!0)):$(t).find('button[type="submit"] span').html("Wystąpił błąd, odśwież stronę, aby spróbować ponownie")}})}))}$(window).on("load",(function(){jQuery("img.svg").each((function(){var t=jQuery(this),e=t.attr("id"),i=t.attr("class"),n=t.attr("src");jQuery.get(n,(function(n){var o=jQuery(n).find("svg");void 0!==e&&(o=o.attr("id",e)),void 0!==i&&(o=o.attr("class",i+" replaced-svg")),!(o=o.removeAttr("xmlns:a")).attr("viewBox")&&o.attr("height")&&o.attr("width")&&o.attr("viewBox","0 0 "+o.attr("height")+" "+o.attr("width")),t.replaceWith(o)}),"xml")}))})),$(".button--scroll").on("click",(function(t){t.preventDefault();var e=$(this).attr("href");$("html, body").animate({scrollTop:$(e).offset().top},2e3)})),
/*!
