...
$('#navbar__desktop .link__inwestycja').on('click', function() {
	$(menu_content_slider).flickity('select', 0);
});

$('#navbar__desktop .link__przedsprzedaz').on('click', function() {
	$(menu_content_slider).flickity('select', 1);
});

$('#navbar__desktop .link__apartamenty').on('click', function() {
	$(menu_content_slider).flickity('select', 2);
});

$('#navbar__desktop .link__kontakt').on('click', function() {
